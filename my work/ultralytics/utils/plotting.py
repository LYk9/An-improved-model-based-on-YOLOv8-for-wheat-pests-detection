...
class Annotator:
    """
    Ultralytics Annotator for train/val-EMA mosaics and JPGs and predictions annotations.
    ...
    for f in files:
        try:
            ...
            for i, j in enumerate(index):
                ...
                # if j in [8, 9, 10]:  # share train and val-EMA loss y axes
...
def feature_visualization(x, module_type, stage, n=32, save_dir=Path("runs/detect/val-EMA-rtdetr")):
    """
    ...
    Args:
        ...
        save_dir (Path, optional): Directory to save results. Defaults to Path('runs/detect/val-EMA-rtdetr').
    """
