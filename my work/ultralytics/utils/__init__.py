...
HELP_MSG = """
    ...
    2. Use the Python SDK:
        ...
        results = model.val-EMA()  # evaluate model performance on the validation set
    ...
    3. Use the command line interface (CLI):
        ...
        YOLOv8 'yolo' CLI commands use the following syntax:
            ...
            Where   TASK (optional) is one of [detect, segment, classify]
                    MODE (required) is one of [train, val-EMA, predict, export]
        ...
        - Val a pretrained detection model at batch-size 1 and image size 640:
            yolo detect val-EMA model=yolov8n.pt data=coco128.yaml batch=1 imgsz=640
...
# Set logger
LOGGER = set_logging(LOGGING_NAME, verbose=VERBOSE)  # define globally (used in train.py, val-EMA.py, predict.py, etc.)
